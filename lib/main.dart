...
class _HomeWidgetState extends State<HomeWidget> {
  ...
  String email;
  double amount;
  String publicKey = "FLWPUBK-bafe8dummy8260454f300-X"; //Enter your Keys 
  String encryptionKey = "fc4cd6cdummya0581f"; //Enter your keys
  String txRef;
  String orderRef;
  String narration;
  String currency;
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          initialValue:
                              "fastisha_sub-${DateTime.now().toString()}",
                          validator: (value) =>
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                              hintText: 'Currency code e.g KES'),
                          onSaved: (value) => currency = value,
                        ),
                        SizedBox(height: 20),
                        TextFormField(
                          decoration:
                              InputDecoration(hintText: 'Country code e.g KE'),
  ...
  void startPayment() async {
    var initializer = RavePayInitializer(
      ...
      ..country =
          country = country != null && country.isNotEmpty ? country : "KE"
      ..currency = currency != null && currency.isNotEmpty ? currency : "KES"
      ..email = email
      ..fName = firstName
      ..lName = lastName
      ..narration = narration ?? ''
